...
| Deleting the Vault key behind Secrets encryption makes every existing Secret inaccessible and fails upgrades | Key rotation is safe; key deletion is recoverable only by recreating the cluster | Jul 2026, [docs](https://docs.oracle.com/en-us/iaas/Content/ContEng/Tasks/contengencryptingdata.htm) |
