...
| A gateway's VCN needs a DHCP option set with a working DNS resolver | Host names in the deployment specification won't resolve without one | Jul 2026, [docs](https://docs.oracle.com/en-us/iaas/Content/APIGateway/Concepts/apigatewayprerequisites.htm) |
